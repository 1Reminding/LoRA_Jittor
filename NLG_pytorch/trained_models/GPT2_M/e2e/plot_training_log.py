...
# Log file path
log_file = '/root/LoRA/NLG_pytorch/trained_models/GPT2_M/e2e/log.txt'
...
plt.tight_layout()
plt.savefig('/root/LoRA/NLG_pytorch/trained_models/GPT2_M/e2e/training_curves.png', dpi=300)
plt.savefig('/root/LoRA/NLG_pytorch/trained_models/GPT2_M/e2e/training_curves.pdf')
plt.show()

print(f"Charts saved to '/root/LoRA/NLG_pytorch/trained_models/GPT2_M/e2e/training_curves.png' and '.pdf'")